...
const (
	...
	envDirEnvKey  string = "ENV_DIR" // envDirEnvKey is the environment variable that specifies the directory to look for the .env file
)
...
// readFromEnv reads the configuration variables from the .env file
